...
- Interpret feature intent correctly: Notes are documentation and requirements; an ERD is a schema design; DB Client is live database metadata; a Flowchart is process logic and control flow. Cross-reference them only when the evidence supports the connection.
